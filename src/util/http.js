...
module.exports = {
    ...
    405: "**405**, method not allowed, ex. " + JSON.stringify({ status: 405, error: 'only methods POST and GET are allowed'}),
    403: "**403**, i got it but it is rejected ex. " + JSON.stringify({ status: 403, error: 'the database is closed, open it to add data '}),
