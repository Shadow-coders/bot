...
const commands = [
  new SlashCommandBuilder()
    .setName("music")
    .setDescription("The command group for the music commands!")
    .addSubcommand(() =>
      subcommand("lyrics", "The lyrics of a song").addStringOption((s: any) =>
        s
          .setName("song")
          .setDescription("The lyrics of a song you want to get")
          .setRequired(true)
      )
    )
